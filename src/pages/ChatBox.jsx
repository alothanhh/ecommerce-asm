    ...
    return (
        <>
            ...
            <div className="container my-3 py-3">
                ...
                <hr />
                <h5 className="text-center fs-5 weight-light">Quý khách hàng có thắc mắc vui lòng đặt câu hỏi tại đây</h5>
                        ...
                        <MainContainer style={{height:"65vh"}}>
                            <ChatContainer>
                                <MessageList
                                    ...
                                    typingIndicator={isTyping ? <TypingIndicator content="Sourique Corner đang nhập..." /> : null}
                                >
                                ...
                                <MessageInput placeholder="Nhập câu hỏi" onSend={handleSendRequest} />
                            </ChatContainer>
                        </MainContainer>
                    </div>
                </div>
